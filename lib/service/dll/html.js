...
module.exports = ({ plugin, env }, options, projectOptions) => {
  ...
  //
  const defined = service ? Object.assign({}, service.define) : {}
  const appData = Object.assign({}, env.APP_DATA_DEFINED_PROCESS)
  //
  ...
  Object.keys(pages).forEach((page) => {
    plugin.use(`html-${page}`, (args) => {
      ...
      // 模板参数注入环境变量数据
      arg.templateParameters = Object.assign({}, envData, templateParameters)
      return [arg]
    })
  })
}
